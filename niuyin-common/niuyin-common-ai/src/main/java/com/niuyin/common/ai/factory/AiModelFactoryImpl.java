package com.niuyin.common.ai.factory;
...
import com.niuyin.common.ai.config.NiuyinAiAutoConfiguration;
import com.niuyin.common.ai.config.NiuyinAiProperties;
...
import com.niuyin.common.ai.model.siliconflow.SiliconFlowImageApi;
import com.niuyin.common.ai.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            NiuyinAiProperties.MidjourneyProperties properties = SpringUtil.getBean(NiuyinAiProperties.class)
                    .getMidjourney();
